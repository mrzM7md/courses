...
import 'package:course_dashboard/features/sections/courses/presentaion/widgets/course_category_item_widget.dart';
                  ...
                  appButton(
                    ...
                    buildWhen: (previous, current) => current is GetCategoriesState,
                      builder: (context, state) {
                        ...
                        return Wrap(
                          children: catsPaginated.data.map((category) => CourseCategoryItemWidget(category: category, onTap: (){

...
class CategoriesEndpointsActions implements BaseCategoriesEndpointsActions {
  ...
  @override
  Future<Either<ErrorModel, SuccessModel<String?>>> deleteCategoryAsync({required int categoryId}) async {
    try{
      Response response = await ApiConstance.deleteData(
          url: ApiConstance.httpLinkDeleteCategory(categoryId: categoryId),
        accessToken: ""
      );

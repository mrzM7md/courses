...
class _NavigationItemsWidgetState extends State<NavigationItemsWidget> {
  ...
  builder: (context, state) {
      ...
      children: [
        ...
        NavigationItemWidget(navigationImage: postImage, navigationName: "المنشورات",
          bgColor: state is ChangeDashboardSectionsState && state.section == DashboardSectionsEnum.POSTS ? Color(appColorGrey) : null,
          onTap: (){
            appCubit.changeDashboardSection(section: DashboardSectionsEnum.POSTS);
          },),
        NavigationItemWidget(navigationImage: surveysImage, navigationName: "الاستبيانات",
          bgColor: state is ChangeDashboardSectionsState && state.section == DashboardSectionsEnum.SURVEYS ? Color(appColorGrey) : null,
          onTap: (){
